...
$.widget("bootstrap.bwizard", {
	...
	next: function () {
		...
		// if (index = 1) {
		// 	document.getElementById('preview_entrega_o').innerHTML=document.getElementById('txt_entrega_o').value;
		// 	document.getElementById('preview_origen_o').innerHTML=document.getElementById('txt_dep_o').value;
		// 	document.getElementById('preview_area_o').innerHTML=document.getElementById('txt_area_o').value;
		// 	document.getElementById('preview_cargo_o').innerHTML=document.getElementById('txt_cargo_o').value;
