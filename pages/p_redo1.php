  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <div id='pnl_Atenciones' class="panel panel-default" style='height: 100%;' >
        ...
        <div class="panel-body">
          <div class="carousel slide" data-ride="carousel" id=resultados_A>
            <!-- begin carousel-inner -->
            <div class="carousel-inner">
              <!-- begin item -->
              <div class="item active">
                <div id='tb_comp_A1' class="table-responsive"></div>
              </div>
              <!-- end item -->
              <!-- begin item -->
              <div class="item">
                <div id='tb_comp_A2' class="table-responsive"></div>
              </div>
              <div class="item">
                <div id='tb_comp_A3' class="table-responsive"></div>
              </div>
            </div>
          </div>
        </div>
...
function mostrarResultados(){
  ...
  panio=document.getElementById('sl_anio').value;
  pmes=document.getElementById('sl_mes').value;
