...
$resultado2=$claseConsulta5->compFechas_atenciones($anio1,$anio2,$mes,$fechaActualuzacion);
...
if (sizeof($resultado)>0 ){
  echo  "<table id='tb_response_fecha_I' class='table tablesorter table-bordered'>
    <thead>
    <tr>
      <th rowspan='2'class='bg-silver f-s-12 text-center'>FECHA</th>
...
<th class='bg-silver f-s-12 text-center'>Atenciones</th>
 ...
 for ($i=0; $i <sizeof($resultado) ; $i++) {
   echo   "<tr>
          <td class='p-3 f-s-11 text-center m-r-10 m-l-10'> ".$resultado[$i]['fecha']."</td>
